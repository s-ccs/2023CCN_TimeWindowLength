...
function calc_time_models(evts,dat,tWinList,sfreq)
	...
	for twindow = tWinList  
		...
		),evts,dat, eventcolumn="event_type");
...
# ╔═╡ 392a573b-e21a-4db5-8872-214df6e4e3f2
...
# ╔═╡ 27d8c77d-2137-4b08-bac5-c26a511afbcd
sub = "037"
...
# ╔═╡ c670011e-c708-428d-85ad-8bd8fc195245
design_lm = Dict(
		"stimulus"=>(
...
begin
	...
	#channel_list = ["Pz"]
	dat = pyconvert(Array,raw.get_data(picks="Pz")).*10^6;
end
...
# ╔═╡ 6132236f-3230-4ea9-8955-dafcd8821183
events

# ╔═╡ c2140c35-67c6-43ff-a5d9-affea185ea3c
size(@subset(events, :event_type .== "stimulus"))
...
# ╔═╡ 22ab3e09-bed0-42c4-bd10-d26caa573894
let
...
let
	...
	d = @subset(dFull, :basisname .!= "response")
...
begin
	...
	d1 = @subset(dF, :basisname .!= "response")
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "7099d02d683447e3cb77a6020d892c3a38cf4236"
